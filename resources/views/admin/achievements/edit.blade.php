...
@section('content')
    ...
    @endif
    {!! Form::open(['route' => ['admin.achievements.update',$achievement->id], 'method'=>'put','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-9">
                    ...
                    <div class="tab-content" id="custom-tabs-two-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="uz" role="tabpanel" aria-labelledby="home-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('uz_title', $achievement->translate('uz')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('uz_content', 'Контент (*)')}}
                                {{Form::textarea('uz_content', $achievement->translate('uz')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------oz latin--------------------------------}}
                        <div class="tab-pane fade" id="oz" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('oz_title', $achievement->translate('oz')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('oz_content', 'Контент (*)')}}
                                {{Form::textarea('oz_content', $achievement->translate('oz')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------ru--------------------------------}}
                        <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('ru_title', $achievement->translate('ru')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('ru_content', 'Контент (*)')}}
                                {{Form::textarea('ru_content', $achievement->translate('ru')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------en--------------------------------}}
                        <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('en_title', $achievement->translate('en')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('en_content', 'Контент (*)')}}
                                {{Form::textarea('en_content', $achievement->translate('en')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-4">
                        {{Form::label('thumbnail', 'Картинка', ['class' => 'col-form-label'])}} <br><br>
                        <img src="{{$achievement->getImagePath('thumbnail', 'thumb')}}" alt="" width="100"> <br><br>
                    ...
                    <button type="submit" class="btn btn-info"><i class="fas fa-edit"></i> Обновить подвиг</button>
