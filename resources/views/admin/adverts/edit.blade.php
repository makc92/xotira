...
@section('content_header')
    <h1 class="m-0 text-dark">Обновить Объявление</h1>
@stop
...
@section('content')
    ...
    @endif
    {!! Form::open(['route' => ['admin.adverts.update',$advert->id], 'method'=>'put','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-9">
                    ...
                    <div class="tab-content" id="custom-tabs-two-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="uz" role="tabpanel" aria-labelledby="home-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('uz_title', $advert->translate('uz')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('uz_content', 'Контент (*)')}}
                                {{Form::textarea('uz_content', $advert->translate('uz')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------oz latin--------------------------------}}
                        <div class="tab-pane fade" id="oz" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('oz_title', $advert->translate('oz')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('oz_content', 'Контент (*)')}}
                                {{Form::textarea('oz_content', $advert->translate('oz')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------ru--------------------------------}}
                        <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('ru_title', $advert->translate('ru')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('ru_content', 'Контент (*)')}}
                                {{Form::textarea('ru_content', $advert->translate('ru')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------en--------------------------------}}
                        <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::text('en_title', $advert->translate('en')->title, $attributes = ['class' => 'form-control'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('en_content', 'Контент (*)')}}
                                {{Form::textarea('en_content', $advert->translate('en')->content, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-4">
                        ...
                        <img src="{{$advert->getImagePath('thumbnail','thumb')}}" alt=""> <br><br>
                    ...
                    <button type="submit" class="btn btn-info"><i class="fas fa-edit"></i> Обновить</button>
