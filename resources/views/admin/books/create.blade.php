...
@section('content')
    ...
    @endif
    {!! Form::open(['route' => 'admin.books.store', 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-9">
                    ...
                    <div class="tab-content" id="custom-tabs-two-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="uz" role="tabpanel" aria-labelledby="home-tab">
                            <div class="form-group">
                                ...
                                {{Form::textarea('description[uz]', null, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------oz latin--------------------------------}}
                        <div class="tab-pane fade" id="oz" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="form-group">
                                ...
                                {{Form::textarea('description[oz]', null, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------ru--------------------------------}}
                        <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::textarea('description[ru]', null, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                        {{--------------------------------en--------------------------------}}
                        <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="form-group">
                                ...
                                {{Form::textarea('description[en]', null, $attributes = ['class' => 'form-control'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <i>Размер картинки не должен превышать <b>1МБ</b></i> <br>
                    ...
                    <button type="submit" class="btn btn-success"><i class="fas fa-plus-square"></i> Добавить книгу</button>
