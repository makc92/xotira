    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 col-md-10 text-center">
                <h5 class="alt-font font-weight-700 text-extra-dark-gray width-80 mx-auto margin-35px-bottom lg-width-100">
                    {{__('menu.3d')}}</h5>
                <a href="https://uzbekistan360.uz/ru/location/telebasna-oJ-k" target="_blank" class="btn btn-medium btn-rounded btn-transparent-dark-gray">батафсил</a>
            </div>
        </div>
    </div>
</section>
