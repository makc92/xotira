<section class="padding-30px-all">
    <div class="container">
                ...
                <div
                    ...
                    <div class="blog-post blog-post-style1 text-center text-md-left">
                        <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                            <a href="{{route('news.show',[app()->getLocale(),$result->translate(app()->getLocale())->slug] )}}">
                                <img src="{{$result->thumbnail ? $result->getImagePath('thumbnail', 'thumb') : asset('images/fakernews.jpg')}}" alt="">
                            </a>
                        </div>
